    ...
    <v-container fluid class="mt-2 mb-0">
      <v-layout wrap align-start justify-center row fill-height class="my-0">
        <v-flex xs12 md8 class="mb-0">
          ...
          <!-- <v-divider></v-divider> -->
          <p class="google-font mt-3" style="font-size:110%">Our events are open to newbies, developers, managers, and organisations who are interested in Flutter and its technologies or use them as part of their projects.</p>
          ...
          <p class="google-font mt-0 ml-0" style="font-size:130%" >
            ...
            <p class="google-font mb-0" style="font-size:120%">Questions? Please contact <a style="color:#1565C0;text-decoration: none;" :href="`mailto:${ChapterDetails.ChapterEmail}`">{{ChapterDetails.ChapterEmail}}</a>.</p>
        </v-flex>
